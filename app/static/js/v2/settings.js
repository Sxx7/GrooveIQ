...
(function () {
    ...
    /* integrationCard moved to components.js (session 07) so it can be
     * reused by Monitor → Integrations with mode='live'. The Settings call
     * site above passes mode='configured' (the default) implicitly via the
     * `snapshot: true` flag. */
})();
